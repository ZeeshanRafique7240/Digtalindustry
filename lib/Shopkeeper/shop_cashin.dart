...
class Shop_cash_in extends StatefulWidget {
  const Shop_cash_in({Key? key}) : super(key: key);

  @override
  State<Shop_cash_in> createState() => _Shop_cash_inState();
}

class _Shop_cash_inState extends State<Shop_cash_in> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      drawer: drawerapp(),
      appBar: AppBar(title: Text("Cash In")),
      body: Column(
        children: [
          Padding(
