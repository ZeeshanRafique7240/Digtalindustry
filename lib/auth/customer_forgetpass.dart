...
class Customer_forget extends StatefulWidget {
  const Customer_forget({Key? key}) : super(key: key);

  @override
  State<Customer_forget> createState() => _Customer_forgetState();
}

class _Customer_forgetState extends State<Customer_forget> {
